pipeline {
    ...
    stages {
     ...
     stage('Build Docker Image') {
            steps {
                ...
                sh 'cd /home/ubuntu/jenkinsws/workspace/urldetector && sudo docker build -t $JOB_NAME:v1.$BUILD_ID .'
	...
	stage('Login to Docker Hub') {
            steps{
                ...
                sh 'sudo podman login docker.io -u swar2001 -p $DOCKER_HUB_PASSWD'
    // some block
}
